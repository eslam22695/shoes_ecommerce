...
<div class="row">
    <div class="main-title-00">
        ...
        <a style="color: #fff;" href="{{ route('admin.sole.index') }}">/ النعول / </a>
...
<div class="row">
    <div class="col-12">
        <div class="card-box">
            <h4 class="header-title m-t-0 m-b-20">تعديل نعل</h4>

            <table class="table table-bordered table-striped">
                {{ Form::model($sole, ['method' => 'PATCH', 'action' => ['App\Http\Controllers\Admin\SoleController@update', $sole->id], 'files' => true]) }}
                <tbody>
                    <tr>
                        <td>اسم </td>
                        <td><input type="text" class="form-control" name="name" required value="{{ $sole->name }}"></td>
                        @if ($errors->has('name'))
