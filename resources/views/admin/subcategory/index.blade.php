            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class=" main-btn-00">
                        <!-- Responsive modal -->
                        <a href="{{ route('admin.sub_category.create',$parent_id) }}" class="btn btn-default waves-effect">اضافه قسم فرعي +</a>
                    </div>
                </div>
            </div>
            ...
            <div class="table-responsive">
                <table data-toggle="table" data-search="true" data-show-columns="true" data-sort-name="id" data-page-list="[8, 16, 32]" data-page-size="8" data-pagination="true" data-show-pagination-switch="true" class="table-bordered ">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><img src="{{asset('admin_assets/images/subcategories/'.$category->image)}}" class="img-responsive" width="100px" height="100px"></td>
                            <td>{{$category->name}}</td>
                            ...
                            <td class="actions">
                                ...
                                <a href="{{ route('admin.sub_category.edit',$category->id) }}" class="btn btn-success waves-effect" title="تعديل">تعديل</a>
                            ...
                            <div class="modal-dialog" style="width:55%;">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer" style="text-align:center">
                                        <form action="{{ route('admin.sub_category.destroy',$category->id) }}" method="POST">
                                            {{csrf_field()}}
