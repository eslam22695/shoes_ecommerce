...
<div class="row">
    <div class="main-title-00">
        ...
        <a style="color: #fff;" href="{{ route('admin.category.index') }}">/ قسم فرعي / </a>
...
<div class="row">
    <div class="col-12">
        <div class="card-box">
            <h4 class="header-title m-t-0 m-b-20">اضافه قسم فرعي</h4>

            <table class="table table-bordered table-striped">
                {{Form::open(['method'=>'POST','action' => ['App\Http\Controllers\Admin\SubCategoryController@store'], 'files' => true])}}
                @csrf
                <tbody>
                    <input type="hidden" class="filestyle" name="parent_id" value="{{ $parent_id }}">
                    <tr>
                        <td>الصورة</td>
                        <td>
