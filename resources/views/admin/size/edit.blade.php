...
<div class="row">
    <div class="main-title-00">
        ...
        <a style="color: #fff;" href="{{ route('admin.size.index') }}">/ المقاسات / </a>
...
<div class="row">
    <div class="col-12">
        <div class="card-box">
            <h4 class="header-title m-t-0 m-b-20">تعديل مقاس</h4>

            <table class="table table-bordered table-striped">
                {{ Form::model($size, ['method' => 'PATCH', 'action' => ['App\Http\Controllers\Admin\SizeController@update', $size->id], 'files' => true]) }}
                <tbody>
                    <tr>
                        <td>اسم </td>
                        <td><input type="text" class="form-control" name="name" required value="{{ $size->name }}"></td>
                        @if ($errors->has('name'))
