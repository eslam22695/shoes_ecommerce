                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="actions">
                                ...
                                <a href="{{ route('admin.product_image.index',$product->id) }}" class="btn btn-info waves-effect" title="صور المنتج">صور المنتج</a>
                                <a href="{{ route('admin.product_size.index',$product->id) }}" class="btn btn-warning waves-effect" title="مشاهدة">المقاسات</a>
