...
<div class="row">
    <div class="main-title-00">
        ...
        <a style="color: #fff;" href="{{ route('admin.category.index') }}">/ قسم رئيسي / </a>
...
<div class="row">
    <div class="col-12">
        <div class="card-box">
            <h4 class="header-title m-t-0 m-b-20">تعديل قسم رئيسي</h4>
            ...
            <table class="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>اسم </td>
                        <td><input type="text" class="form-control" name="name" required value="{{ $category->name }}"></td>
                        @if ($errors->has('name'))
                        <span class="alert alert-danger">
